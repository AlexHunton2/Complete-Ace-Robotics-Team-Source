...
public class DriveRotateGyro extends Command
{
	...
	public DriveRotateGyro(DriveTrain.RobotDirection direction, double speed, double angle)
	{
...
//		DriveTrain.getInstance().driveRotateLeftNormal();
		isFinished = DriveTrain.getInstance().goToAngle(getID(), angle, speed, direction);
	}
